module Cursor
  module PageScopeMethods
    ...
    def next_cursor
      @_next_cursor ||= result.size == all.limit_value ? result.last.try(default_paginate_by) : nil
    end
    ...
    def direction
      ...
      @_direction ||= prev_cursor < result.last.try(default_paginate_by) ? :after : :before
    end
